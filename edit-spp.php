    ...
    <div class="card-body">
       <form action="proses.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tahun" aria-describedby="tahunHelp" name="tahun" required value="<?= $row['tahun']; ?>">
            </div>
            <div class="mb-3">
                <label for="nominal" class="form-label">Nominal</label>
                <input type="text" class="form-control" id="nominal" name="nominal" required value="<?= number_format($row['nominal']); ?>">
            </div>
            <div>
