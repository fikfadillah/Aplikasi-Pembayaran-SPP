...
$totalData1 = $data->dataBarang($tableName1);
$totalData2 = $data->dataBarang($tableName2);
$totalData3 = $data->dataBarang($tableName3);
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $totalData3; ?></div>
                            </div>
                            <div class="col">
